      ...
      <div className="">
        ...
        <div className="flex flex-col lg:flex-row items-center sm:mt-[8%] lg:mt-[20%] w-[100%] px-[20px] sm:px-[80px] mt-[7%] justify-center lg:justify-between sm:gap-[90px] gap-[120px] ">
          <div className="sm:w-[80%] lg:w-[38%] text-center lg:text-left">
            <p className="font-barlow-condensed text-[#D0D6F9] sm:text-3xl text-[18px]"> SO, YOU WANT TO TRAVEL TO</p>
            <h1 className="font-bellefair sm:text-[112px] text-white text-[80px]">SPACE</h1>
          ...
          <div>
            <p className="text-[#0B0D17] text-[20px] font-bellefair  bg-white py-[60px] px-[30px]  sm:py-[80px] sm:px-[50px] lg:px-[50px] lg:py-[80px] rounded-[100%]">EXPLORE</p>
          </div>
        </div>
      </div>
    </div>
